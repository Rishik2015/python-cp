# Write a program to check whether the student can take an exam or not. Students will be allowed only in two conditions: If they have a medical cause (‘Y’ for  and ‘N’ for no). If yes, then they will be allowed. If No, then check attendance If attendance is above 75, then allowed; otherwise, not allowed.

# medicalcause=input("do you have a medical cause?(y/n)")
# if(medicalcause=="y"):
#     print("you are allowed to take exam")
# else:
#     attendence=int(input("enter your attendencce"))  
#     if(attendence>75):
#         print("you are allowed to take exam")
#     else:
#         print("you are not all owed to take exam") 
# 
